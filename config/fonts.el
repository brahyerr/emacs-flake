;; Set fonts for emacs
(set-face-attribute 'default nil :font "lemonHiDpi" :height 200)
(set-face-attribute 'tooltip nil :font "lemonHiDpi" :height 200)

(add-to-list 'default-frame-alist '(font . "lemonHiDpi"))
(set-fontset-font t 'unicode (font-spec :name "lemonHiDpi") nil)
...
(set-frame-font "lemonHiDpi" nil t)
